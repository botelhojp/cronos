...
import br.ppgia.openjade.cronos.util.Format;
import java.util.GregorianCalendar;

/**
 * Classe que abstrae um conta de um agente. A conta � adminstrada por um agente
 * cliente, porém ela manipulada por conta das dicas de um �nico servidor, ou
 * seja, a conta está relacionada a um cliente e a um �nico servidor.
 *
...
public class Count {
    ...
    /**
     * Retorna o valor atual da conta, ou seja, o valor em dinheiro e o valor em
     * papéis.
     *
     * @return
     */
    ...
    public Cotacao getCotacao() {
        return AcaoDAO.getInstance().getCotacao(acao, GregorianCalendar.getInstance().getTime());
    }
}
